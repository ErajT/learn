...
app.use((req, res, next) => {
  // res.setHeader('Access-Control-Allow-Origin', 'https://857c-39-48-197-134.ngrok-free.app'); // Adjust the origin as needed
...
app.use(cors({
  // origin: 'https://857c-39-48-197-134.ngrok-free.app', // Allow requests from frontend application
